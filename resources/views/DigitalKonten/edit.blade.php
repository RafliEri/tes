...
<head>
    ...
    <title>Digital Konten | Edit Data</title>
...
<section class="bg-white flex items-center justify-center" style="height: 100vh; padding-bottom: 3rem">
  <div class="py-8 px-4 lg:py-16" style="width: 40vw;">
      ...
      <form action="{{ route('digitalkonten.update', $digital_kontens->id) }}" method="POST"
          ...
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 pb-10">
              <div class="sm:col-span-2">
                  ...
                  <input type="text" name="nama_konten" id="nama_konten" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full" placeholder="Masukkan Nama File" required="" style="background-color:#D9D9D9;"
                  value="{{ $digital_kontens->nama_konten }}">
              </div>
              <div class="sm:col-span-2">
              ...
              <input type="file" class="block w-full text-sm text-gray-500
                ...
                value="{{ $digital_kontens->preview_media }}">
                </label>
              </div>
          </div>
