...
<nav class="fixed top-0 z-50 border-b border-gray-200 w-full dark:border-gray-700" style="z-index: 0; background-color:#D9D9D9; left: 17vw; width: 83vw;">
  ...
  <!-- Sidebar -->
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" style="width: 17vw;" aria-label="Sidebar">
      <div class="role py-10 text-white flex item-center justify-center bg-gray-800">
          <img src="../image/logo.png" class="w-24 md:w-24 max-w-full max-h-full">
      </div>
  <div class="h-full px-3 pb-4 pt-5 overflow-y-auto bg-gray-800">
        <ul class="space-y-3 font-medium">
           <li>
              <a href="{{ url('home') }}" class="flex items-center p-2 rounded-lg text-white bg-gray-700 group">
           ...
           @if (Auth::user()->role == 'superadmin')
              <a href="{{ url('user') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
           ...
           @if (Auth::user()->role == 'superadmin')
           <li>
              <a href="{{ url('karyawan') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                <svg class="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white"
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
           ...
           @if (Auth::user()->role == 'divisi_digital_konten')
              <a href="{{ url('digitalkonten') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
              <svg class="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white"
              xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
           ...
           <li>
            ...
            @elseif (Auth::user()->role == 'divisi_market')
                <a href="#" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                <svg class="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white"
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 1 1 0-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 0 1-1.44-4.282m3.102.069a18.03 18.03 0 0 1-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 0 1 8.835 2.535M10.34 6.66a23.847 23.847 0 0 0 8.835-2.535m0 0A23.74 23.74 0 0 0 18.795 3m.38 1.125a23.91 23.91 0 0 1 1.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 0 0 1.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 0 1 0 3.46" />
           ...
           <li>
            @if (Auth::user()->role == 'divisi_IT')
               <a href="{{ url('it') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
               <svg class="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white"
