      ...
      <form action="{{ route('mitra.store') }}" method="POST"
          ...
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 pb-10">
              <div class="sm:col-span-2">
                  <label for="nama_konten" class="block mb-2 text-sm font-medium text-gray-900 ">Name File</label>
                  <input type="text" name="nama_file" id="nama_konten" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full" placeholder="Ketik nama file" required="" style="background-color:#D9D9D9;">
              </div>
              <div class="sm:col-span-2">
