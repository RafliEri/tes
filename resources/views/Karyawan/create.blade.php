...
<head>
    ...
    <title>Karyawan | Create Data</title>

    <script src="https://cdn.tailwindcss.com?plugins=forms,typography,aspect-ratio,line-clamp,container-queries"></script>
</head>
<body>
<section class="bg-white flex items-center justify-center" style="height: 100vh;">
      ...
      <form action="{{ route('karyawan.store') }}" method="POST"
          ...
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 pb-10">
              <div class="sm:col-span-2">
                  ...
                  <input type="text" name="nama" id="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full" placeholder="Masukan Nama" required="" style="background-color:#D9D9D9;">
              </div>
              ...
              <div class="sm:col-span-2">
                  ...
                  <input type="number" name="no_telp" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full [&::-webkit-inner-spin-button]:appearance-none [appearance:textfield]" placeholder="Masukan No.Telepon" required="" style="background-color:#D9D9D9;">
              </div>

              <div class="sm:col-span-2">
                  <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Jabatan</label>
                  <input type="text" name="jabatan" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full" placeholder="Pilih Jabatan" required="" style="background-color:#D9D9D9;">
              </div>
